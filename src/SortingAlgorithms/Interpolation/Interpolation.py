def interpolation_search_normal_collection(sorted_collection, item):
    ...
    """
    try:
        __assert_sorted_normal_collection(sorted_collection)
    except ValueError:
...
def __assert_sorted_normal_collection(collection):
...
def __assert_sorted(collection):
    ...
    ValueError: Collection must be ascending sorted
    """
    if collection != sorted(collection, key=lambda x: x.salary):
        raise ValueError("Collection must be ascending sorted")
    return True
